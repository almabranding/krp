...
<body  class="login-page">
    <div id="login-box">
        <div id="header">
            <a href="index.php" > <div id="logo" style="margin:auto;"><img src="<?= URL ?>public/img/logo.png"></div></a>
        ...
        <div class="form-box">
            <form method="post" action="<?= URL ; ?>users/run" >
                ...
                <br />
                <br />
                <div id="login-box-name"></div><input type="submit" value="LOGIN" class="login-box-button"/>
            </form>
        </div>
    </div>
</body>